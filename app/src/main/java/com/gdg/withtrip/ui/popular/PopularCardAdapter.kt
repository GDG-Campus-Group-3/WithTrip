...
class PopularCardAdapter(
    private val popularCardEventListener: PopularCardEventListener) : ListAdapter<PopularCard,PopularCardViewHolder>(PopularCardDiff) {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): PopularCardViewHolder {
        return PopularCardViewHolder(
            TripCard1V2Binding.inflate(LayoutInflater.from(parent.context),parent,false),
